...
export default async function SuperusuarioLayout({
  ...
  return (
    // El portal superusuario reutiliza páginas del supervisor (dashboard-supervisor,
    // carga-trabajo) cuyo TopBar usa useMobileMenu(); el provider debe existir aquí
    // también para que no truene fuera del layout de supervisor.
    <MobileMenuProvider>
