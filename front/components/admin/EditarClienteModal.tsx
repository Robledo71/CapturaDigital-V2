    ...
    >
      <div className="bg-white dark:bg-[#0c1829] border border-slate-100 dark:border-[#1a2d4d] rounded-xl shadow-2xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-blue-200 dark:border-[#1a2d4d]">
          <h2 id="modal-editar-cliente-titulo" className="text-blue-950 dark:text-white font-semibold text-base">
            Editar cliente
          </h2>
          <button
            type="button"
        ...
        <form action={dispatch}>
          ...
          <div className="p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="nombre-edit-cliente" className="text-xs font-medium text-blue-600 dark:text-slate-400">
                Nombre del cliente
              </label>
              <input
