...
interface EditarTabletModalProps {
  tablet: TabletRow
  plantas: PlantaRow[]
  onClose: () => void
  onSuccess: (updated: TabletRow) => void
}
...
export function EditarTabletModal({ tablet, plantas, onClose, onSuccess }: EditarTabletModalProps) {
  const [state, dispatch] = useActionState(updateTablet, undefined)
          ...
          <div className="p-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                {state?.errors?.estado && (
                  <p className="text-red-400 text-xs">{state.errors.estado[0]}</p>
                )}
              </div>
