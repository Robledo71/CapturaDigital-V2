  ...
  return (
    <div className="flex-1 overflow-auto p-4 sm:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Matriz */}
        <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0c1829]">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-700">
                <th className="text-left font-semibold text-slate-600 dark:text-slate-300 px-4 py-3 sticky left-0 bg-white dark:bg-[#0c1829] z-10">
                  Permiso
                </th>
                {columns.map((rol) => (
                  <th
    ...
    <>
      <tr className="bg-slate-50 dark:bg-[#0f2138]">
        <td
          ...
          className="px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 sticky left-0"
        >
      ...
      {group.permisos.map((p) => (
        ...
        >
          <td className="px-4 py-2.5 sticky left-0 bg-white dark:bg-[#0c1829]">
