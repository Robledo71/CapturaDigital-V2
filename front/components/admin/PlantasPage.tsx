            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex-1 sm:flex-none">
                ...
                <input
                  ...
                  className="pl-9 pr-4 py-2 text-sm rounded-lg bg-white dark:bg-[#0c1829] border border-blue-200 dark:border-[#1a2d4d] text-slate-800 dark:text-slate-200 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/40 w-full sm:w-64 transition-colors"
                />
              </div>
              {/* Add button */}
              <button
