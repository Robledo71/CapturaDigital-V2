    ...
    <>
      ...
      <div className="px-4 h-20 flex items-center gap-3 border-b border-white/15 dark:border-[#1a2d4d]">
        ...
        <div className="min-w-0">
          ...
          <p className="text-blue-100 dark:text-[#64748b] text-xs leading-tight mt-0.5">v2 · Servicio de inspección</p>
        </div>
            ...
            {visibleItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={
                    active
                      ? 'flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-blue-700 dark:text-white bg-white dark:bg-[#1a3a5c]'
                      : 'flex items-center gap-3 px-3 py-2 rounded-xl text-sm text-white/85 dark:text-slate-400 hover:bg-white/10 dark:hover:bg-[#1a2d4d] hover:text-white dark:hover:text-white transition-colors'
                  }
                >
      ...
      <div className="px-3 pb-4 border-t border-white/15 dark:border-[#1a2d4d] pt-4 relative bg-[#4B6994] dark:bg-transparent">
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            ...
            <p className="text-blue-100 dark:text-slate-400 text-xs leading-tight mt-0.5 truncate">{rolDisplay}</p>
          </div>
          <ChevronDown
            size={14}
