...
export function StatCard({ label, value, subtitle, dotColor, chart }: StatCardProps) {
  return (
    <div className="rounded-2xl bg-white p-6 flex flex-col gap-3 border border-slate-100 shadow-sm dark:bg-[#0f2038] dark:border-[#0f2038] dark:shadow-none transition-all duration-200 hover:shadow-lg hover:scale-[1.02]">
